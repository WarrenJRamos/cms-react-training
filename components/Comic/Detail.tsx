...
export const Detail = ({ issueNumber, publishDate, creators }: DetailProps) => {
    return (
        <ul className={classes["detail-list"]}>
            ...
            <li className={classes["detail-list-item"]} data-testid="published-date">
                <span className={classes["lead"]}>Published:</span> {getDate(publishDate)}
            </li>
            <li className={classes["detail-list-item"]} data-testid="creator-names">
